...
this.$= new nativo.default($$[$0],_$[$0].first_line,_$[$0].first_column);
break;
}
},
...
case 15:return 5;
break;
case 16:inicio.listaErrores.push(new errores.default('ERROR LEXICO',yy_.yytext,this._$.first_line,this._$.first_column)); console.log("lexi "+yy_.yytext);
break;
}
},
